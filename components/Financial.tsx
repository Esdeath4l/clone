  ...
  <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-3 gap-10">
      ...
      <div className="lg:col-span-2 space-y-10 bg-[#EEEEEE] p-6 rounded-xl shadow-md">
        <div className="space-y-4">
          ...
          />
          <h1 className="text-4xl font-bold text-gray-800">Financial Reporting</h1>
        ...
        <div className="border-t pt-6 space-y-4">
          <h2 className="text-2xl font-semibold">Flexible and Software-Agnostic Solutions</h2>
          <p className="text-gray-700">
        ...
        <div className="border-t pt-6 space-y-4">
          <h2 className="text-2xl font-semibold">Software Proficiency</h2>
          <ul className="list-disc pl-6 text-gray-700">
...
<div className="space-y-10 bg-[#393E46] p-6 rounded-xl shadow-md text-[#EEEEEE]">
  ...
  <div className="bg-[#222831] p-4 rounded-lg space-y-4 shadow">
    ...
    <p className="italic text-gray-300">
      “Outsourcing bookkeeping to Konnect has freed up so much of our internal bandwidth...”
    </p>
