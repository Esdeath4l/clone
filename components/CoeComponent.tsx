...
export default function CoeComponent() {
  return (
    <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-3 gap-10">
      ...
      <div className="lg:col-span-2 space-y-10 bg-[#EEEEEE] p-6 rounded-xl shadow-md">
        ...
        <div className="border-t pt-6 space-y-4">
          ...
          <p className="text-gray-700">
            Their large inventory required meticulous management. Inadequate product tagging caused inaccurate balances and COGS calculations.
          </p>
        </div>
        ...
        <div className="border-t pt-6 space-y-4">
          ...
          <p className="text-gray-700">
            They sold across platforms like Shopify, Amazon, Etsy, and wholesale. Sales needed precise classification and reporting to reflect profitability and manage operations.
          </p>
        </div>
        ...
        <div className="border-t pt-6 space-y-4">
          ...
          <p className="text-gray-700">
            Standardized inventory processes and reclassified all products.<br /><br />
            Tagged inventory appropriately for proper financial reflection.<br /><br />
            Segregated inventory types and ensured accurate reporting.<br /><br />
            Booked sales by channels for better insights and analysis.<br /><br />
            Mapped channel-based costs to derive profitability.<br /><br />
            Leveraged financial models to streamline decisions and improve profitability.
          </p>

          <h4 className="text-xl font-semibold text-gray-800 pt-6">Results</h4>
          <p className="text-gray-700">
            Prompt and accurate reflection of business activities. Enhanced bookkeeping quality and reliable financial data.
          </p>
        </div>
      </div>
