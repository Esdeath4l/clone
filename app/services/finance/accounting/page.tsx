...
import Accounting from '../../../../components/ServiceAccounting';
import Link from 'next/link';
export default function AccoutingPage(){
  return(
    <>
      <motion.div
  ...
  <div className="max-w-3xl w-full text-center mx-auto">
          ...
          >
             <Link href="/"> Home </Link> / <Link href="/services/finance/accounting">Services/ Accounting</Link>
          </motion.h6>
        </div>
        </div>
      </section>
