...
import MaAdvisory from '../../../../components/M&A';
import Link from 'next/link';

export default function MaAdvisorymain(){
  return(
    <>
      <motion.div
  ...
  <div className="max-w-3xl w-full text-center mx-auto">
          ...
          >
             <Link href="/"> Home </Link> / <Link href="/services/finance/ma-advisory">Services/ M & A Advisory</Link>
          </motion.h6>
        </div>
        </div>
      </section>
