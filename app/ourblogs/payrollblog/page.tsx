 ...
 <section className="relative h-[70vh] bg-[#0D1B2A] text-white overflow-hidden">
  ...
  <div className="max-w-3xl w-full text-center mx-auto">
      ...
      <div className="bg-[#FAFAFA] min-h-screen flex items-center justify-center p-4">
        <div className="max-w-3xl w-full bg-white text-[#222831] rounded-lg shadow-lg overflow-hidden">
          <div className="w-full bg-white px-4 py-2 flex justify-between items-center text-sm border-b text-[#222831]">
