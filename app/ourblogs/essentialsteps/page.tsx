...
export default function Essentialsteps() {
  return (
    <>
      <TopBar />
      <InfoTab />
      ...
      <section className="relative h-[70vh] bg-[#0D1B2A] text-white overflow-hidden">
        ...
        <div className="relative h-[70vh] bg-cover bg-center flex items-center justify-center text-center px-4">
          <div className="max-w-3xl w-full text-center mx-auto">
            ...
            >
              <Link href="/">Home</Link> / <Link href="/ourblogs">Our Blog</Link> / <Link href="/ourblogs/essentialsteps">12 Essential Steps</Link>
            </motion.h6>
          </div>
        </div>
      </section>
      ...
      <div className="bg-gray-100 min-h-screen flex items-center justify-center p-4">
        <div className="max-w-3xl w-full bg-white rounded-lg shadow-md overflow-hidden">
          ...
          {/* Blog Text */}
              <div className="p-6">
                  <h1 className="text-3xl font-bold mb-4">12 Essential Steps Every CPA Should Take to Prepare for Tax Season</h1>
