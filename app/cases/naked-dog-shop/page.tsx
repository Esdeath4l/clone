...
import NakedDogComponent from '../../../components/NakedDogComponent';
import Link from 'next/link';
export default function NakedDog() {
  return (
    <>
      <TopBar />
      <InfoTab />
      ...
      <section className="relative h-[70vh] bg-[#0D1B2A] text-white overflow-hidden">
        ...
        <div className="relative h-[70vh] bg-cover bg-center flex items-center justify-center text-center px-4">
         ...
         NakedDog Shop
            ...
            >
              <Link href="/"> Home </Link> / <Link href="/cases/naked-dog-shop"> Cases / NakedDog Shop </Link>
            </motion.h6>
          </div>
        </div>
      </section>
