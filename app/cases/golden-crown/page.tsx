...
import GoldernCrown from '../../../components/GolderCrown';
import Link from 'next/link';

export default function GoldenCrownPanaderia() {
  return (
    <>
      <TopBar />
      <InfoTab />
      ...
      <section className="relative h-[70vh] bg-[#0D1B2A] text-white overflow-hidden">
        ...
        <div className="relative h-[70vh] bg-cover bg-center flex items-center justify-center text-center px-4">
          <div className="max-w-3xl w-full text-center mx-auto">
            ...
            >
              <Link href="/"> Home </Link> / <Link href="/cases/golden-crown"> Cases / Golden Crown Panaderia </Link>
            </motion.h6>
          </div>
        </div>
      </section>

      {/* GoldernCrown Component Section */}
      <motion.section
        {...{
